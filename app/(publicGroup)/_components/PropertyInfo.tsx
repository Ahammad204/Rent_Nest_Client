  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-bold uppercase rounded bg-primary/10 text-primary">
          <Home className="w-3 h-3" />
          {property.propertyType}
        </span>
        {property.category && (
          <span className="inline-flex items-center gap-1 px-3 py-1 text-xs font-bold uppercase rounded bg-secondary/10 text-secondary">
