  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 sm:-mt-10 lg:-mt-12 relative z-30">
      <BlueprintCard className="p-4 sm:p-6 shadow-md" accentTick>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 divide-y sm:divide-y-0 sm:divide-x divide-[#D8DBD3]">
          {stats.map((stat, idx) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-1.5 text-[#C98A2C] mb-1">
                  <IconComp className="w-4 h-4" />
                </div>
                <div className="font-mono-spec text-2xl sm:text-3xl font-bold text-[#1F4D3E] tracking-tight">
                  {stat.number}
                </div>
                <div className="text-xs sm:text-sm text-[#1B211E]/80 font-medium mt-0.5">
                  {stat.label}
                </div>
              </div>
            );
