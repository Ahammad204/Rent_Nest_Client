...
export function Hero({
  ...
  return (
    <section className="relative pt-6 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 border-b border-[#D8DBD3] bg-[#F4F5F1]">
      {/* Background Dot Grid Pattern */}
      <div
        className="absolute inset-0 opacity-15 pointer-events-none -z-10"
        style={{
          backgroundImage: `radial-gradient(#1F4D3E 1px, transparent 1px)`,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            {/* Spec Badge */}
            <div className="inline-flex items-center gap-2 font-mono-spec text-xs tracking-widest text-[#1F4D3E] bg-white border border-[#D8DBD3] px-3 py-1 rounded-md shadow-xs">
              <span className="w-2 h-2 rounded-full bg-[#C98A2C] animate-pulse" />
              <span>RENTAL BLUEPRINT • BD MARKET</span>
              <span className="text-[#D8DBD3]">•</span>
              <span className="font-bold">
                {totalListingsCount} VERIFIED HOMES
              </span>
            </div>

            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#1B211E] leading-tight">
              Find your next home in{" "}
              <span className="text-[#1F4D3E] underline decoration-[#C98A2C] underline-offset-4">
                {filters.city === "All" ? "Bangladesh" : filters.city}
              </span>
            </h1>

            <p className="text-sm sm:text-base text-[#1B211E]/80 max-w-xl font-normal leading-relaxed">
            ...
            {/* Search Bar Card */}
            <BlueprintCard
              className="p-4 sm:p-5 text-[#1B211E] shadow-sm bg-white"
              accentTick
            >
              {/* City Tabs */}
              <div className="flex items-center gap-2 mb-4 pb-3 border-b border-[#D8DBD3]">
                <span className="font-mono-spec text-xs text-[#1F4D3E] font-semibold">
                  LOCATION:
                </span>
                {(["All", "Dhaka", "Chattogram"] as const).map((city) => (
                  <button
                    ...
                    className={`h-7 px-3 text-xs font-semibold rounded-lg border transition-all ${
                      filters.city === city
                        ? "bg-[#1F4D3E] text-white border-[#1F4D3E] hover:bg-[#173B2F]"
                        : "bg-[#F4F5F1] text-[#1B211E] border-[#D8DBD3] hover:bg-[#D8DBD3]/50"
                    }`}
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <div className="space-y-1">
                  <label className="font-mono-spec text-[10px] text-[#1F4D3E] font-medium flex items-center gap-1">
                  ...
                  <select
                    ...
                    className="w-full bg-[#F4F5F1] border border-[#D8DBD3] rounded-md px-3 py-2 text-xs font-medium text-[#1B211E] focus:outline-none focus:border-[#1F4D3E]"
                  >
                ...
                <div className="space-y-1">
                  <label className="font-mono-spec text-[10px] text-[#1F4D3E] font-medium flex items-center gap-1">
                    <Building2 className="w-3 h-3 text-[#C98A2C]" />
                    PROPERTY TYPE
                  </label>
                  <select
                ...
                <div className="space-y-1">
                  <label className="font-mono-spec text-[10px] text-[#1F4D3E] font-medium flex items-center gap-1">
                    <Banknote className="w-3 h-3 text-[#C98A2C]" />
                    MAX RENT (BDT)
                  </label>
                  <select
                ...
                <div className="space-y-1">
                  <label className="font-mono-spec text-[10px] text-[#1F4D3E] font-medium flex items-center gap-1">
                    <BedDouble className="w-3 h-3 text-[#C98A2C]" />
                    BEDROOMS
                  </label>
                  <select
              ...
              <div className="mt-4 pt-3 border-t border-[#D8DBD3] flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="relative w-full sm:w-2/3">
                  ...
                  <input
                    ...
                    className="w-full h-9 pl-9 pr-3 text-xs bg-[#F4F5F1] border border-[#D8DBD3] rounded-lg text-[#1B211E] focus:outline-none focus:border-[#1F4D3E]"
                  />
                </div>
                <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                  <button
                    type="button"
                    onClick={handleReset}
                    className="h-9 px-3 text-xs font-medium border border-[#D8DBD3] text-[#1B211E] hover:bg-[#F4F5F1] rounded-lg inline-flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="h-9 px-5 bg-[#1F4D3E] hover:bg-[#173B2F] text-white text-xs font-semibold rounded-lg inline-flex items-center gap-1.5"
                  >
          ...
          <div className="lg:col-span-5 relative min-h-[380px] sm:min-h-[420px] flex items-center justify-center pt-4 lg:pt-0">
            ...
            {featuredProperties.length > 0 ? (
              <>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      <BlueprintCard className="bg-white p-2" accentTick>
                        <div
                          className={`relative ${layout.aspect} rounded overflow-hidden bg-[#F4F5F1]`}
                        >
                          {img ? (
                            <img
                              src={img}
                          ...
                          <div className={`absolute ${layout.badgePos}`}>
                            ...
                            >
                              {layout.badgeIcon && (
                                <ShieldCheck className="w-3 h-3 mr-0.5 text-[#C98A2C]" />
                              )}
                          ...
                          <div className="absolute bottom-2 left-2 right-2 bg-black/70 backdrop-blur-sm text-white p-2 rounded text-xs flex items-center justify-between">
                            ...
                            <div className="font-mono-spec font-bold text-[#C98A2C] text-xs whitespace-nowrap ml-2">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <BlueprintCard className="p-8 bg-white text-center" accentTick>
                  <Home className="w-12 h-12 text-[#1F4D3E] mx-auto mb-3" />
                  <p className="font-heading font-bold text-sm text-[#1B211E]">
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-3 right-4 z-50 bg-[#1F4D3E] text-white px-3 py-1.5 rounded border border-[#173B2F] shadow-md flex items-center gap-2">
